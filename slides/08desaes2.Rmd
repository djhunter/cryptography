...
Implement addition and multiplication in $\mbox{GF}(2^8) = \mathbb{Z}_2[x]/(x^8+x^4+x^3+x+1)$. Polynomials are raw bytes.
...
>- **AES has replaced DES** as an NIST endorsed cryptosystem, and is widely used today (2020).
...
Work on your group's [Jamboard](https://jamboard.google.com/d/1wzXHqGPc2fVgqpCK0E1c7DWpXPF-UC7GhjPSxys-weE/edit?usp=sharing). 
