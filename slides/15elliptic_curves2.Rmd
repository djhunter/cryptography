...
>- **Programming assignment:** Implement addition for mod $p$ elliptic curves.
...
```{r, message=FALSE}
library(gmp)
gcd(as.bigz(2)^factorialZ(7)-1, as.bigz("540143"))
```
```{r}
540143/421
```
...
Work in groups on [this Jamboard](https://jamboard.google.com/d/14LzeJLMqDbCaIm7HuGocNWzPWS3yGoDJ6y2K19qn9Ok/edit?usp=sharing).
