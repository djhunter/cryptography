...
2. If $s\neq 0$, compute $s^{-1} r(\alpha^{l+1})$. This will be a power of $\alpha$ (why?), and the power (minus 1) gives the location of the error.
...
2. If $s\neq 0$, compute $s^{-1} r(\alpha^{l+1})$. This will be a power of $\alpha$, and the power (minus 1) gives the location of the error. 
