...
- If $g^r = 1$ for some $r<p-1$, then $r$ must divide $(p-1)/q_k$ for some $k$.
...
Work on your group's [Jamboard](https://jamboard.google.com/d/1aZFmY7o_eEHQSDMD2K_8juyS4yV_hRYiX9LTOgKI62Y/edit?usp=sharing). 
...
- Since $12^{20} \equiv -1 \pmod{41}$, we know $L_7(12) \equiv 1 \pmod{2}$.
    - In fact, *$L_7(12) \equiv 5 \pmod{8}$*. (Details omitted.)
- Since $12^{40/5} \equiv 18 \pmod{41}$, and $7^{40/5} \equiv 37 \pmod{41}$, and $37^3 \equiv 18 \pmod{41}$, we know *$L_7(12) \equiv 3 \pmod{5}$*. 
