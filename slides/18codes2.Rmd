...
Let $C$ be a binary code. The **minimum distance** $d(C)$ of $C$ is the minimum of $d(v)$ for all $v\in C$.
...
**[Jamboard](https://jamboard.google.com/d/1GIIhJqPSgI-N769vjH9Zx5ZyD_yGvVDrfV4rox5yJm4/edit?usp=sharing) Exercise.** Complete the table.
...
>    - *Singleton bound* 
>    - Delete the first $d-1$ digits from every code word; the remaining digits still have to be different in at least one place.
...
[Jamboard](https://jamboard.google.com/d/1GIIhJqPSgI-N769vjH9Zx5ZyD_yGvVDrfV4rox5yJm4/edit?usp=sharing) Exercise:
...
**Definition.** A binary code that achieves the above bound is called **perfect**.
