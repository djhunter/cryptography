...
3. Add the `hillCipher` function to your R package, with appropriate documentation and examples.  Show, by example, that changing one letter of plaintext can change more than one letter of ciphertext. How much of the ciphertext changes? Does it matter which letter of plaintext changes?
