...
3. Add the file (hillcipher.R)[../R/hillcipher.R] function to your R package and rebuild.  Show, by example, that changing one letter of plaintext can change more than one letter of ciphertext. How much of the ciphertext changes? Does it matter which letter of plaintext changes? (TODO: make hillcipher.R)
